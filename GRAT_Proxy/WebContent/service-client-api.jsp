	...
	function eventHandler(message) {
		switch (message.event) {
			case "agent":
				...
				break;
			case "interaction":
				if(message.data.eventType=="INVITED"){
					if(message.data.interaction.userData.ENT_Function=="CustSrvc"){
						console.log("condition1 successful!");
					}
				}else if (message.data.eventType=="ACCEPTED"){
					if(message.data.interaction.userData.ENT_Function=="CustSrvc"){
						console.log("condition2 successful!");
					}
				}
